...
def find_index_at_distance(center: tuple, min_radius: float, max_radius: float, points: list):
    # Find the index of the points that are at a distance between min_radius and max_radius from the center
    indexes = []
