...
def create_directory_path():
    ...
    i = 0
    while os.path.exists(os.path.join(os.path.dirname(__file__), "../data/simulation_result/result_{}".format(i))):
        i += 1
    path = os.path.join(os.path.dirname(__file__), "../data/simulation_result/result_{}".format(i))
    os.makedirs(path)
